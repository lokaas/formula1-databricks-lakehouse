...
# MAGIC
# MAGIC 1. Create a dataframe with list of nationalities and corresponding geographis region
# MAGIC 2. write the dataframe to gold ref_natiobality_region table
...
# MAGIC %md 
# MAGIC Step 1 - Create a dataframe with list of nationalities and corresponding geographis region
...
# MAGIC %md
# MAGIC Step 2 - write the dataframe to gold ref_natiobality_region table
